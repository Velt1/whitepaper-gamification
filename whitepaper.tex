...
\author{Max Fritsche}
{DHSN Duale Hochschule Sachsen, Staatliche Studienakademie Leipzig, Germany, and Security Robotics D\&S GmbH, Germany}{s5002242@edu.dhsn.de}{}{}
...
\supplement{Software: The prototype includes infrastructure-dependent components and cannot be publicly released. A demonstration build is available from the authors upon request.}
...
We chose a 2D top-down pixel-art style, inspired by \textit{The Legend of Zelda} \cite{nintendo1986zelda}. This aesthetic is nostalgic, accessible, and reduces cognitive load compared to complex 3D environments.
\begin{itemize}
...
To avoid purely extrinsic behavior, the economy is constrained by educational guardrails: rewards are tied to verified submissions, repeated low-value grinding is dampened, and collaborative achievements are prioritized over raw leaderboard chasing. This balances competition and inclusion, consistent with findings on social comparison and reward design in educational systems \cite{sosnovsky2020socialcomparison,park2021leaderboard}.
...
A cohort of 60 bachelor's students will be split into an \textit{Experimental Group} (RPG) and a \textit{Control Group} (Traditional).
\begin{itemize}
...
This multidimensional instrument set is aligned with prior evaluation designs in gamified programming education \cite{figueiredo2020motivation,ibanez2014casestudy,hellin2023engagement}.
